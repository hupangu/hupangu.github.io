...
![sonatype-start](assets/sonatype-start.png)
...
![sonatype-create](assets/sonatype-create.png)
...
输入 O 后会提示你设置密码
![sonatype-password](assets/sonatype-password.png)
...
![gradle-task](assets/gradle-task.png)
...
![maven-release](assets/maven-release.png)
